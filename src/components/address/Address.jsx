    ...
    return (
        <div className="mainAddressContainer">
            ...
            <div className="personal2">
                    ...
                    <div style={{width:374, height:80}}>{props.allAddressList.address}</div>
            </div>
            <div className="personal">
                <div className="personal1">
            ...
            <Radio.Group style={{marginLeft:42}} onChange={onChange} value={props.allAddressList.typeId}>
                <Radio value={1}>Home</Radio>
                <Radio value={2}>Work</Radio>
                <Radio value={3}>Other</Radio>
            </Radio.Group>
            <button className="continueShopping1" onClick={listenOrderSummery}>Continue</button>
        </div>
    )
}
